...
class lungsPoint extends StatefulWidget {
...
class _footPageState extends State<lungsPoint>{
  @override
        ...
        children: <Widget>[
          Center(
            ...
            //   height: (MediaQuery.of(context).size.height)/2,
              ...
              width: 800,
                child: Image(
                  ...
                  image: AssetImage('assets/lungsP.jpg',),
           ...
           // onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => reflexesDetailsPage()));},
            ...
            //
            Center(child: Container(child: Text('NOTE : All Pink coloured Area'),)),
           Center(
             child: Padding(
