...
class sciaticNervPoint extends StatefulWidget {
...
class _footPageState extends State<sciaticNervPoint>{
  @override
   ...
   return Scaffold(
    ...
    //  backgroundColor: Colors.lightBlueAccent[100],
     ...
     backgroundColor: Colors.white,
      ...
      appBar: AppBar(
        //title: Text('Nose Pressure Point',style: TextStyle(color: Colors.black),),
      backgroundColor: Colors.white,
        elevation: 0.0,
            ...
            //   height: (MediaQuery.of(context).size.height)/2,
              ...
              width: 800,
                child: Image(
                  ...
                  image: AssetImage('assets/scNervesP.jpg',),
