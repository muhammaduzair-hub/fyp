...
import 'package:reflexology/pages/points/tracheaPoint.dart';

class tracheaDetail extends StatelessWidget {
                ...
                child: ListTile(
                  title: Column(
                   ...
                   child: Text('Pressure Point',style: TextStyle(color: Colors.redAccent,fontSize: 22,fontWeight: FontWeight.w400)),
                     onPressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => (tracheaPoint()))); },
